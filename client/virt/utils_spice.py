...
def start_vdagent(guest_session, test_timeout):
    ...
    try:
        ...
        logging.info("------------ End of guest checking for Spice Vdagent"
                     " Daemon ------------")
...
def verify_vdagent(guest_session, test_timeout):
    ...
    try:
        ...
        logging.info("----------- End of guest check to see if vdagent package"
                     " is available ------------")
...
def verify_virtio(guest_session, test_timeout):
    ...
    try:
        ...
        logging.info("------------ End of guest check of the Virtio-Serial"
                     " Driver------------")
